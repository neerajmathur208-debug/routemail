  ...
  return (
    <div className="flex bg-slate-50 min-h-screen">
      ...
      <main className="flex-1 lg:ml-64 p-6 lg:p-10 max-w-[1500px]">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm max-w-2xl">
              Phase 1 — Inbox Availability + Ownership management. Capacity Planner and the
              30-day projection engine are next.
            </p>
          </div>
        ...
        >
          <CapacityCard
            label="Remaining Capacity Today"
...
function CapacityCard({ label, value, estimate, testid }) {
  return (
    <div
      data-testid={testid}
